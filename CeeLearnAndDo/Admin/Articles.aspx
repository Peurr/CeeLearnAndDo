...
<asp:Content ID="Content4" ContentPlaceHolderID="content" runat="server">
    ...
    <section class="overview">
        <asp:GridView ID="GridView1" runat="server" AutoGenerateDeleteButton="true" OnRowDeleting="GridView1_RowDeleting" AutoGenerateColumns="False" GridLines="None" CssClass="table table-striped" DataKeyNames="Id" DataSourceID="DataSource">
            <Columns>
                ...
                <asp:BoundField DataField="DateAdded" HeaderText="Date Created" SortExpression="DateAdded" />
            </Columns>
        </asp:GridView>
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="postbox">
                    ...
                    <div class="inside">
                        <div class="actions">
                            <a href="~/Admin/Articles.aspx?action=overview">Nevermind</a><asp:Button ID="butPublish" OnClientClick="jsToAsp()" CssClass="btn btn-primary mtopbut" runat="server" Text="Publish" OnClick="butPublish_Click" />
                        </div>
                    </div>
                </div>
                <div class="postbox">
                    ...
                    <div class="actions">
                        <a class="add" href="Categories.aspx">+ Add new category</a>
                    </div>
                </div>
                <div class="postbox">
                    <h3>Tags</h3>
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="postbox">
                    ...
                    <div class="inside">
                        <div class="actions">
                            <a href="~/Admin/Articles.aspx?action=overview">Nevermind</a><asp:Button ID="btnEdit" OnClientClick="jsToAspEdit()" CssClass="btn btn-primary mtopbut" runat="server" Text="Publish" OnClick="btnEdit_Click" />
                        </div>
                    </div>
                </div>
                <div class="postbox">
